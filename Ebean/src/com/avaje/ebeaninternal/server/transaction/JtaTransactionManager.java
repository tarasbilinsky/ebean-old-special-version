    ...
    public Object getCurrentTransaction() {
        ...
        if (ut == null){
            // no current JTA transaction
                logger.trace("JTA Transaction - no current txn");
            return null;
        }
    ...
    private static class JtaTxnListener implements Synchronization {
        ...
        public void afterCompletion(int status) {
            ...
            case Status.STATUS_COMMITTED:
                    logger.trace("Jta Txn ["+transaction.getId()+"] committed");                    
            ...
            case Status.STATUS_ROLLEDBACK:
                    logger.trace("Jta Txn ["+transaction.getId()+"] rollback");                    
            ...
            default:
                logger.trace("Jta Txn ["+transaction.getId()+"] status:"+status);                    
            }

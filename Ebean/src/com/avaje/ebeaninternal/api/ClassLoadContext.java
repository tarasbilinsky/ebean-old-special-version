...
class ClassLoadContext {
    ...
    public ClassLoader getDefault(boolean preferContext) {
        ...
        if (contextLoader == null){
            ...
            logger.trace("No Context ClassLoader, using "+callerLoader.getClass().getName());

            return callerLoader;
        }
        if (contextLoader == callerLoader){
                logger.trace("Context and Caller ClassLoader's same instance of "+contextLoader.getClass().getName());
            return callerLoader;
        }
